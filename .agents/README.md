...
## Контекст для AI-агента (DeepSeek-4-Pro + Zoo Code)

Этот файл определяет архитектурные принципы и правила поведения AI-агента. Все генерации кода должны строго соответствовать правилам из `.roo/rules/`.
